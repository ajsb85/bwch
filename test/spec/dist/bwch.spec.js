...
describe("BwCh testing", function () {
  'use strict';

  it('should get bandwidth', function (done) {
    var bwch = new _bwch.BwCh('https://cdn.radiantmediatechs.com/rmp/bandwidth', 4, 2000, true, true);
  ...
  it('should not get bandwidth', function (done) {
    var bwch = new _bwch.BwCh('https://myfakedomain.com', 4, 2000, true, true);
    var bw = bwch.getBandwidth();
    bw.then(function (bandwidth) {
      console.log(bandwidth);
...
},{"../../../src/bwch":291,"babel-polyfill":2}]},{},[292]);
